...
with tab1:
    st.image("fphotos/pappa.jpg",width=600)
with tab2:
    st.image("fphotos/bittu.jpg",width=600)
with tab3:
    st.image("fphotos/mumma.jpg",width=600)
...
st.image("fphotos/familypic.jpg",width=300)
st.audio("fphotos/fam.unknown")
